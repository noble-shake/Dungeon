...
public class ResetActionFlag : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.ResetTrigger("TransitionStart");

        character.isPerformingAction = false;
        character.characterAnimatorManager.applyRootMotion = false;
        character.characterAnimatorManager.currentAnimationType = AnimationType.None;
        character.characterLocomotionManager.canMove = true;
        character.characterLocomotionManager.canRotate = true;
        character.characterCombatManager.canGuard = true;
        ...
        character.characterCombatManager.DisableCanDoCounterAttack();
        character.characterCombatManager.DisableIsInvulnerable();
        character.characterCombatManager.DisableCanDoEvade();
        character.characterCombatManager.DisableCanDoDoubleDash();
        character.characterCombatManager.lastAttackAnimationPerformed = string.Empty;
        // 기사의 스페셜 어택때문에 생김.
        (character.characterLocomotionManager as PlayerLocomotionManager)?.EnableGravitySettings();
